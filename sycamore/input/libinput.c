...
static bool setAccelSpeed(struct libinput_device *device, double speed) {
...
static bool setAccelProfile(struct libinput_device *device,
...
static bool setTap(struct libinput_device *device,
...
static bool setNaturalScroll(struct libinput_device *device, bool n) {
...
static bool deviceIsTouchpad(struct wlr_input_device *device) {
